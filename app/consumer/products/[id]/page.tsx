        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 p-6 md:p-8">
            ...
            <div className="aspect-square bg-gray-100 rounded-lg overflow-hidden relative mb-4">
              ...
              {product.isSold && (
                <div className="absolute inset-0 bg-black/50 flex items-center justify-center">
                  <div className="bg-gray-800 text-white px-6 py-3 rounded-full text-xl font-bold shadow-lg">
                    판매완료
                  </div>
                </div>
              )}
          ...
          <div className="flex flex-col">
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className={`font-semibold ${
                    ...
                    {product.isSold ? '판매완료' : product.isAvailable ? '판매중' : '품절'}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-3 mb-6">
              {product.isSold ? (
                <div className="w-full px-6 py-4 bg-gray-100 border-2 border-gray-300 text-gray-500 rounded-lg font-semibold text-center">
                  ...
                  <p className="text-sm mt-2 text-gray-400">다른 상품을 둘러보세요</p>
                </div>
              ) : product.isAvailable ? (
                <>
                  <button
